...
void system_init()
{
  ...
  LL_GPIO_SetPinPull(CONTROL_SAFETY_DOOR_PORT, CONTROL_SAFETY_DOOR_PIN, LL_GPIO_PULL_UP);
  #endif
  // TODO:
...
uint8_t system_control_get_state()
{
  ...
  if(!LL_GPIO_IsInputPinSet(CONTROL_SAFETY_DOOR_PORT, CONTROL_SAFETY_DOOR_PIN)) {
